...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const category = await categoryDB.getAllCategory(client);
    
    // 성공적으로 users를 가져왔다면, response를 보내줍니다.
    res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.READ_ALL_CATEGORY_SUCCESS, category));
